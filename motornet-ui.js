// Consolidated Motornet UI helpers.
// Data is loaded directly by app.js from data/cars_motornet.json.
// This file only handles autocomplete/grouped trim UI, lightbox and small policy fixes.
...
(function(){
  ...
  document.addEventListener('motornet:ready', start);
  ...
  // Inline UI policy fixes: EV bollo label, photovoltaic validation and Motornet badge removal.
  (function(){
    function byId(id){ return document.getElementById(id); }
